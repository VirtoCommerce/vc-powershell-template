...
```command
.\Module_Template.ps1 -ModuleName CustomerReviews -Author "Jon Doe" -CompanyName VirtoCommerce -PlatformVersion "3.62.0" -PlatformNuGetPackageVersion "3.62.0"
```
...
6. `PlatformVersion` and `PlatformNuGetPackageVersion` parameters have "3.62.0" "3.62.0" default values respectively. You can skip these parameters if you use default versions
