...
namespace {Namespace}.Web
{
    ...
    {
        // private readonly string _connectionString = ConfigurationHelper.GetConnectionStringValue("{Namespace}") ?? ConfigurationHelper.GetConnectionStringValue("VirtoCommerce");
